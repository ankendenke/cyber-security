...
It sounds pretty simple! Let's walk through the process an attacker would have to follow in an example scenario. Navigate to [http://10.10.185.247:8089/](http://10.10.185.247:8089/) and follow the instructions in the questions below.
